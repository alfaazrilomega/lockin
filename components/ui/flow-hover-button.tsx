...
export const FlowHoverButton = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & { icon?: React.ReactNode }>(
    ...
    return (
      <button
        ...
        className={cn(
          ...
          px-8 py-3 font-semibold text-zinc-800 dark:text-zinc-200 transition-all duration-500
